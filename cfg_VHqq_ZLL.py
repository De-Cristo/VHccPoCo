...
cfg = Configurator(
    ...
    workflow_options = {"dump_columns_as_arrays_per_chunk": 
                        "root://eosuser.cern.ch//eos/user/l/lichengz/BDT_train_VHqq_ZLL_MC_1221/"} if parameters["save_arrays"] else {},
    ...
    categories = {
        ...
        # "SR_mm_2J_cJ": [Zll_2j('mu'), ctag_j1, dijet_mass_cut, Hcc_flag(True)
        #                ],
        # "SR_ee_2J_cJ": [Zll_2j('el'), ctag_j1, dijet_mass_cut, Hcc_flag(True)
        #                ],
        # "SR_ll_2J_cJ": [Zll_2j(), ctag_j1, dijet_mass_cut, Hcc_flag(True)
        #                ],
...
#         "CR_ll_2J_CC": [Zll_2j('both'), ctag_j1, dijet_invmass_cut, Hcc_flag(True)
#                        ],
#         "CR_ee_2J_CC": [Zll_2j('el'), ctag_j1, dijet_invmass_cut, Hcc_flag(True)
#                        ],        
#         "CR_mm_2J_CC": [Zll_2j('mu'), ctag_j1, dijet_invmass_cut, Hcc_flag(True)
#                        ],
    },
...
#                     "SR_ll_2J_cJ": [ ColOut("events", outVariables, flatten=False), ],
...
#                     "CR_ll_2J_LF": [ ColOut("events", outVariables, flatten=False), ],
                       
#                     "CR_B_ll": [ ColOut("events", outVariables, flatten=False), ],
#                     "CR_ll_2J_HF": [ ColOut("events", outVariables, flatten=False), ],
                
#                     "CR_B_ll": [ ColOut("events", outVariables, flatten=False), ],
#                     "CR_BB_ll": [ ColOut("events", outVariables, flatten=False), ],
                
#                     "SR_2L2B_ee": [ ColOut("events", outVariables, flatten=False), ],
#                     "SR_ee_2J_cJ": [ ColOut("events", outVariables, flatten=False), ],
...
#                     "CR_ee_2J_LF": [ ColOut("events", outVariables, flatten=False), ],
#                     "CR_ee_2J_HF": [ ColOut("events", outVariables, flatten=False), ],
#                     "CR_ee_2J_CC": [ ColOut("events", outVariables, flatten=False), ],
                
#                     # "baseline_ZLLHBB_2J_mm": [ ColOut("events", outVariables, flatten=False), ],
#                     "SR_2L2B_mm": [ ColOut("events", outVariables, flatten=False), ],
#                     "SR_mm_2J_cJ": [ ColOut("events", outVariables, flatten=False), ],
...
#                     "CR_mm_2J_LF": [ ColOut("events", outVariables, flatten=False), ],
#                     "CR_mm_2J_HF": [ ColOut("events", outVariables, flatten=False), ],
#                     "CR_mm_2J_CC": [ ColOut("events", outVariables, flatten=False), ],
                }
         },
    },
